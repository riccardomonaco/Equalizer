/*
  ==============================================================================
    ...
    DbMeter.h
    Created: 11 Feb 2025 11:12:40pm
    Author:  Dev
...
class DbMeter : public juce::Component, public juce::Timer
{
public:
	DbMeter(std::function<float()>&& valueFunction) : valueSupplier(std::move(valueFunction))
	{
		startTimerHz(30);
	}
